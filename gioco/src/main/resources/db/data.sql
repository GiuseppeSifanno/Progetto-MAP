...
('o20', 'Cappello da Capitano',   'Il glorioso cappello del Capitano. Inspira fiducia, inspiegabilmente.', 'cappello_capitano.png', FALSE),
('o21', 'Mappa',   'Una mappa sgualcita dell''isola.', 'mappa.png', FALSE);
